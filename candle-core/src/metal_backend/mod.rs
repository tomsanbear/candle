    ...
    fn to_dtype(&self, layout: &Layout, dtype: DType) -> Result<Self> {
        ...
        if layout.is_contiguous() {
            let kernel_name = match (self.dtype, dtype) {
                ...
                (DType::I64, DType::I16) => "cast_i64_i16",
                ...
                (DType::I32, DType::I16) => "cast_i32_i16",
                ...
                (DType::I16, DType::I64) => "cast_i16_i64",
                (DType::I16, DType::I32) => "cast_i16_i32",
            ...
            let kernel_name = match (self.dtype, dtype) {
                ...
                (DType::BF16, DType::I16) => "cast_bf16_i16_strided",
                ...
                (DType::F16, DType::I16) => "cast_f16_i16_strided",
                ...
                (DType::F32, DType::I16) => "cast_f32_i16_strided",
                ...
                (DType::I64, DType::I16) => "cast_i64_i16_strided",
                ...
                (DType::I32, DType::I16) => "cast_i32_i16_strided",
                (DType::I32, DType::U32) => "cast_i32_u32_strided",
                (DType::I32, DType::U8) => "cast_i32_u8_strided",

                (DType::I16, DType::BF16) => "cast_i16_bf16_strided",
                (DType::I16, DType::F16) => "cast_i16_f16_strided",
                (DType::I16, DType::F32) => "cast_i16_f32_strided",
                (DType::I16, DType::I64) => "cast_i16_i64_strided",
                (DType::I16, DType::I32) => "cast_i16_i32_strided",
                (DType::I16, DType::U32) => "cast_i16_u32_strided",
                (DType::I16, DType::U8) => "cast_i16_u8_strided",
